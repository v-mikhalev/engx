---
stoplight-id: g6gd98q08xfql
tags: [EngX]
---
1. [The Foundation of EngX](#the-foundation-of-engx)
   1. [Introduction to the Foundation of EngX](#introduction-to-the-foundation-of-engx)
   1. [Agile Fundamentals](#agile-fundamentals)
      1. [Elements of Agile Development](#elements-of-agile-development)
      1. [The Agile Mindset](#the-agile-mindset)
      1. [Values and Principles in the Agile Manifesto](#values-and-principles-in-the-agile-manifesto)
         1. [Agile Values](#agile-values)
         1. [Agile Principles](#agile-principles)
      1. [Agile Ways of Working](#agile-ways-of-working)
         1. [What are you doing?](#what-are-you-doing?)
         1. [Shifting from Traditional Waterfall to Modern Agile Development](#shifting-from-traditional-waterfall-to-modern-agile-development)
         1. [Agile Focus Areas](#agile-focus-areas)
         1. [Disadvantages of using Agile](#disadvantages-of-using-agile)
   1. [Implementing Agile with the Scrum Framework](#implementing-agile-with-the-scrum-framework)
      1. [Scrum](#scrum)
         1. [Sprint](#sprint)
         1. [Sprint Planning](#sprint-planning)
         1. [Daily Scrum](#daily-scrum)
         1. [Sprint Review](#sprint-review)
         1. [Sprint Retrospective](#sprint-retrospective)
      1. [Three Pillars of Scrum](#three-pillars-of-scrum)
      1. [Tips for Implementing Scrum](#tips-for-implementing-scrum)
   1. [Evolving Engineering Excellence](#evolving-engineering-excellence)
   1. [Best Practices for Agile](#best-practices-for-agile)
   1. [The EngX Culture](#the-engx-culture)
      1. [The Agile Engineer](#the-agile-engineer)
      1. [Thriving in a Culture of Engineering Excellence](#thriving-in-a-culture-of-engineering-excellence)
      1. [Delivering Value to Clients](#delivering-value-to-clients)
      1. [Evolving Engineering Excellence](#evolving-engineering-excellence)
      1. [Best Practices for Supporting the EngX Culture](#best-practices-for-supporting-the-engx-culture)
   1. [Engineering Practices in Agile-Driven Software Development](#engineering-practices-in-agile-driven-software-development)
      1. [Basic SDLC](#basic-sdlc)
      1. [Building an Agile SDLC](#building-an-agile-sdlc)
      1. [Key Principles of Agile-Driven Software Development](#key-principles-of-agile-driven-software-development)
      1. [Implementing the Key Principles with CI/CD](#implementing-the-key-principles-with-cicd)
      1. [Taking an Agile Approach to a Software Development Project](#taking-an-agile-approach-to-a-software-development-project)
   1. [The Development Phase](#the-development-phase)
   1. [The Testing Phase](#the-testing-phase)
   1. [Best Practices for Ensuring Agility of Your Project](#best-practices-for-ensuring-agility-of-your-project)
   1. [The Foundation of EngX Best Practices Survey](#the-foundation-of-engx-best-practices-survey)
...
Философия Agile делает упор на
 - быстрые релизы, 
 - гибкое планирование, 
 - устойчивое развитие, 
...
Now that you’ve discovered the philosophy and principles behind Agile, you will be better equipped to foster an Agile mindset and incorporate Agile ways of working on your team.

Теперь, когда вы ознакомились с философией и принципами, лежащими в основе Agile, вы будете лучше подготовлены к тому, чтобы развивать гибкое мышление и внедрять гибкие методы работы в своей команде.

You should always be looking for new opportunities for innovation to strengthen your connection with your customers and clients and share your ideas with people throughout your team. While there is no “one size fits all” when it comes to Agile, the more Agile principles you adopt, the greater rewards you and your team will receive. Making the shift to Agile will ensure you and your team continue creating valuable products and innovative solutions.

Вы всегда должны искать новые возможности для инноваций, чтобы укрепить свои связи с клиентами и заказчиками; чтобы поделиться своими идеями с людьми в вашей команде. Хотя, когда дело доходит до Agile, не существует “единого размера для всех”, чем больше принципов Agile вы примете, тем больше вознаграждений получите вы и ваша команда. Переход на Agile гарантирует, что вы и ваша команда продолжите создавать ценные продукты и инновационные решения.
...
### Evolving Engineering Excellence
Now that you’ve discovered more about being an Agile engineer, building a culture of Engineering Excellence, and the business value that both bring to your clients, you will be better equipped to follow these patterns.

Теперь, когда вы узнали больше о том, как быть гибким инженером, как формировать культуру инженерного совершенства и какую ценность для бизнеса они приносят вашим клиентам, вы будете лучше подготовлены к тому, чтобы следовать этим принципам.

Though a behavioral shift takes some time, establishing an EngX culture will make it easier to act in an Agile way. It creates an optimal environment for continuous personal and team improvement of hard and soft skills and becomes a foundation for fruitful work with a client.

Поскольку изменение поведения требует некоторого времени, внедрение культуры EngX облегчит гибкие действия. Это создает оптимальную среду для постоянного личного и командного совершенствования hard и soft skills и становится основой для плодотворной работы с клиентом.
...
Action 2. Make changes faster without increasing costs or degrading quality.
...
Действие 2. Ускоряйте внесение изменений без увеличения затрат или ухудшения качества.
