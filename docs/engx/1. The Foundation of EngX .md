...
- [The Foundation of EngX](#the-foundation-of-engx)
  ...
  - [Implementing Agile with the Scrum Framework](#implementing-agile-with-the-scrum-framework)
    ...
    - [Three Pillars of Scrum](#three-pillars-of-scrum)
      ...
      - [Inspection \\ Осмотр, Инспекция](#inspection--осмотр-инспекция)
      - [Adaptation \\ Адаптация](#adaptation--адаптация)
...
10. Simplicity[^1] — the art of maximizing the amount of work not done — is essential. — Простота — искусство максимизировать объем незавершенной работы - очень важна.
